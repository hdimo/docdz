...
class Patient extends \Application\Entity\Patient implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Patient' . "\0" . '_gendersName', 'lastname', 'firstname', 'gender', 'birthYear', 'phone', 'address', 'consultations', 'id', 'createdDate');
        }
    ...
    public function getGenderByName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGenderByName', array());

        return parent::getGenderByName();
    }
